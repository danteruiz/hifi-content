...
(function() {
    var TABLET_BUTTON_NAME = "HighlightGrab";
    ...
    function hoverDistance() {
        ...
        // Hand pose.
        var handPose = Controller.getPoseValue(Controller.Standard.RightHand);
        var handPosition = Vec3.sum(Vec3.multiplyQbyV(MyAvatar.orientation, handPose.translation), MyAvatar.position);
        //print(handPosition.x + " " + handPosition.y + " " + handPosition.z );
        hoverEnt = Entities.findClosestEntity(handPosition, 1.0);
        
        var pos = Entities.getEntityProperties(hoverEnt).position;
