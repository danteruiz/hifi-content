...
var loadingSphereID = Overlays.addOverlay("model", {
    ...
    url: "http://hifi-content.s3.amazonaws.com/alan/dev/black-sphere-w-horizon-emit.fbx",
...
var loadingDestinationCardID = Overlays.addOverlay("model", {
    name: "Loading-Destination-Card",
    localPosition: { x: 0, y: DESTINATION_CARD_Y_OFFSET, z: 5.5 },
    url: "http://hifi-content.s3.amazonaws.com/alan/dev/loading-blank-mockup.fbx?134",
...
var loadingEllipsisID = Overlays.addOverlay("model", {
    name: "Loading-Ellipsis",
    localPosition: { x: 0, y: 1.5, z: 0 },
    url: "https://hifi-content.s3.amazonaws.com/jimi/graphics/loadingScreen/ellipsis-ring_animation.fbx",
    animationSettings: {
        fps: 100,
        loop: true,
        running: true,
    ...
    dimensions: { x: 12.651470184326172, y: 1.2340905666351318, z: 12.651466369628906 },
    alpha: 1,
    visible: false,
    ignoreRayIntersection: true,
    drawInFront: true,
